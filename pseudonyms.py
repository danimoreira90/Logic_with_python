"""Generate funny names by randomly combining names from 2separate tuples"""
...
first = ('Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie-Weenie'",
         ...
         'Stratchensniff', 'Scut', "Sid 'The Squirts'", 'Skidmark', 'Slaps',
         'Snakes', 'Snoobs', 'Snorki', 'Soupcan Sam', 'Spitzitout', 'Squids',
...
last = ('Appleyard', 'Bigmeat', 'Bloominshine', 'Boogerbottom',
        ...
        'Oxhandler', 'Pealike', 'Peterson', 'Pipelow', 'Pinkerton', 'Porkins',
        'Putney', 'Quakenbush', 'Rainwater', 'Rosenthal', 'Rubbins', 'Sackrider',
        'Snuggleshine', 'Splern', 'Stevens', 'Stroganoff', 'Sugar-Gold',
        'Swackhammer', 'Tippins', 'Turnipseed', 'Vinaigrette', 'Walkingstick',
        'Wallbanger', 'Weemax', 'Weiners', 'Whipkey', 'Wigglesworth', 'Wimplesnatch',
